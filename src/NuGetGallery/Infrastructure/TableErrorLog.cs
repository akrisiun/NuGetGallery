...
namespace NuGetGallery.Infrastructure
{
        public class ErrorEntity // : ITableEntity
        {
            ...
            public string PartitionKey // ITableEntity.
            {
                get;
                set;
            }

            public string RowKey // ITableEntity.
            {
                get;
                set;
            }
            ...
            public long LogicalIndex
            {
                get
                {
                    return 0; // AzureEntityList<ErrorEntity>.GetLogicalIndex(this);
                }
            }
            */
        ...
        public class TableErrorLog : ErrorLog
        {
            ...
            public override ErrorLogEntry GetError(string id)
            {
                ...
                return new ErrorLogEntry(this, id, null); // error.Error);
            }
            ...
            public override int GetErrors(int pageIndex, int pageSize, IList errorEntryList)
            {
                ...
                long queryOffset = 0; // _entityList.LongCount - ((pageIndex + 1) * pageSize);
                if (queryOffset < 0)
                {
            ...
            public override string Log(Error error)
            {
                ...
                long pos = 0; // _entityList.Add(entity);
